...
frappe.query_reports["Payable Summary with Rebate Received"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Payable with Rebate Received"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Accounts Payable with Rebate Received", { company: filters.company });
		});
	},
};

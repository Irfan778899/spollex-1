	...
	for row in stock_ledgers:
		...
		for index, bundle_data in enumerate(serial_nos):
			if index == 0:
				...
				new_args.warranty_expiry_date = formatdate(frappe.db.get_value("Serial No", new_args.serial_no, "warranty_expiry_date"), "dd-mm-yyyy")
				...
				data.append(
					{
						...
						"warranty_expiry_date": formatdate(frappe.db.get_value("Serial No", bundle_data.get("serial_no"), "warranty_expiry_date"), "dd-mm-yyyy"),

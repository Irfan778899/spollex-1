...
class StockBalanceFilter(TypedDict):
	...
	from_date: str
	to_date: str
	item_group: str | list[str] | None
	item_code: list[str] | None
...
class StockBalanceReport:
	...
	def prepare_stock_reco_voucher_wise_count(self):
		...
		if self.filters.get("item_group"):
			childrens = get_item_groups_with_descendants(self.filters.get("item_group"))
			if childrens:
	...
	def get_itemwise_conversion_factor(self):
		items = []
		if self.filters.get("item_code") or self.filters.get("item_group"):

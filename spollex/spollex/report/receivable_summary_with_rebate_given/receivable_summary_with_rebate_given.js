...
frappe.query_reports["Receivable Summary with Rebate Given"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable with Rebate Given"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Accounts Receivable with Rebate Given", { company: filters.company });
		});
	},
};

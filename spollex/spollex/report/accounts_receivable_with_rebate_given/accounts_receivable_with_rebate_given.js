...
frappe.query_reports["Accounts Receivable with Rebate Given"] = {
	"filters": [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Receivable Summary with Rebate Given"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Receivable Summary with Rebate Given", { company: filters.company });
		});
	},
};
